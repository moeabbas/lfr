...
/*
Version history
1.0  (23.09.15) Working version
1.01 (05.10.15) Fixed error in counter0, error was the counter resets
				itself when overflow not on OCR0. 
1.02 (01.12.15) Changed PWM range from 0-100 to 0-250
1.05 (01.12.15) integrated PI controller into this module.
*/
#include <stdio.h>
#include "defines.h"
